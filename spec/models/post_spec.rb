...
RSpec.describe Post, type: :model do
  ...
  it 'has a title as least 2 characters long' do
    post = Post.new(
      title: 'h',
      body: 'A valid body',
      user: current_user,
  ...
  it 'has a body between 5 and 100 characters' do
    ...
    hundred_char_string = 'CECiFRQyzjrH25ycAtafI8BnwY8YSZxZVfFdSuEydIBBS0qdmqYF88gbrFUnHEeyl3gx36a2FdnlJiMdyZfLDrbRbQJTRAzKn3gI'
